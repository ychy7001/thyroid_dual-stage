_base_ = '../configs/mask2former/mask2former_swin-l-in22k-384x384-pre_8xb2-160k_ade20k-640x640.py'
...
num_gpu = 2
adjust_factor = 1 
base_lr = adjust_factor * num_gpu * train_batch_size_per_gpu * 0.01 / (8*2)
