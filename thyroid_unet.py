_base_ = '../configs/unet/unet-s5-d16_fcn_4xb4-160k_cityscapes-512x1024.py'
...
model = dict(
    ...
    test_cfg=dict(crop_size=crop_size[0]),
    data_preprocessor=dict(test_cfg=dict(size_divisor=128))
)
...
num_gpu = 1
adjust_factor = 1 
base_lr = adjust_factor * num_gpu * train_batch_size_per_gpu * 0.01 / (4*4)
