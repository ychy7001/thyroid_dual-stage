_base_ = '../configs/knet/knet-s3_swin-l_upernet_8xb2-adamw-80k_ade20k-512x512.py'
...
model = dict(
    ...
    decode_head=dict(kernel_generate_head=dict(num_classes=num_classes))
)
# training config
...
num_gpu = 2
adjust_factor = 1 
base_lr = adjust_factor * num_gpu * train_batch_size_per_gpu * 6e-05 / (8*2)
